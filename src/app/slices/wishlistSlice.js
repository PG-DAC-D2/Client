...
const staticWishlists = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        addedBy: 'current-user-id',
        addedByUsername: 'Current User',
        addedAt: new Date('2024-01-17').toISOString(),
      },
      {
        _id: 'prod-4',
      ...
      {
        _id: 'prod-5',
        name: 'New Balance 574 Running Shoes',
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        addedBy: 'current-user-id',
        addedByUsername: 'Current User',
        addedAt: new Date('2024-01-21').toISOString(),
      },
      {
        _id: 'prod-8',
      ...
      },
      {
        ...
        addedBy: 'current-user-id',
        addedByUsername: 'Current User',
        addedAt: new Date('2024-01-23').toISOString(),
      },
      {
        _id: 'prod-10',
        ...
        addedBy: 'current-user-id',
        addedByUsername: 'Current User',
        addedAt: new Date('2024-01-24').toISOString(),
      },
    ],
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
