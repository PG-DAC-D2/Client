...
function MansWear() {
  ...
  const filteredProducts = items.filter(p => p.tags?.[0]?.toLowerCase() === activeCategory.toLowerCase());

  const categories = ['shirt', 'tshirt', 'jacket', 'casual', 'kurta'];

  return (
    <section className="section mx-5">
      <div className="section-header">
        <h2>Men's Top Wear</h2>
