...
function CustomerPersonalInfo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const submitData = {
        ...formData,
        // Ensure customerId is explicitly set
        customerId: formData.customerId || user.id,
      };

      console.log("Submitting customer data:", submitData);
      const response = await axios.put("/api/customers/update", submitData);
      ...
      setTimeout(() => {
        console.log("Refreshing customer data to confirm update...");
        fetchCustomerData();
      }, 1000);
